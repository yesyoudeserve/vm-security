...
mostrar_instrucoes() {
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "1. Configure o Security List na Oracle Cloud:"
    ...
    echo ""
    echo "2. Execute a Fase 1 (Adicionar nova porta SSH):"
    echo "   cd $INSTALL_DIR"
    echo "   sudo ./ssh_hardening.sh --fase1"
    echo ""
    echo "3. Teste a nova porta em outro terminal"
    echo ""
    echo "4. Execute a Fase 2 (Criar novo usuário):"
    echo "   sudo ./ssh_hardening.sh --fase2"
    echo ""
    echo "5. Teste o novo usuário:"
    echo "   ssh -p PORTA novo_usuario@seu-ip"
    echo "   ./teste_usuario.sh"
    echo ""
    echo "6. Execute a Fase 3 (Limpeza final):"
